...
"""
Health Check Script for ADF System

Usage:
uv run health_check.py <issue_number>
...
def main():
    ...
    parser = argparse.ArgumentParser(description="ADF System Health Check")
    parser.add_argument(
        "issue_number",
        nargs="?",
    ...
    print("🏥 Running ADF System Health Check...\n")
