...
def save_prompt(prompt: str, adf_id: str, agent_name: str = "ops") -> None:
    ...
    # Create directory structure at project root (parent of core)
    project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    prompt_dir = os.path.join(project_root, "agents", adf_id, agent_name, "prompts")
...
def execute_via_cli_wrapper(request: AgentPromptRequest) -> AgentPromptResponse:
    ...
    save_prompt(request.prompt, request.adf_id, request.agent_name)
