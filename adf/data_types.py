...
# All slash commands used in the ADF system
# Includes issue classification commands and ADF-specific commands
SlashCommand = Literal[
    # Issue classification commands
    "/chore",
    "/bug",
    "/feature",
    # ADF workflow commands
    "/classify_issue",
    "/find_plan_file",
...
class AgentPromptResponse(BaseModel):
    ...
    exit_code: int = 0  # Exit code from Claude execution
    artifacts_path: Optional[str] = None  # Path to artifacts directory
...
class WorkflowContext(BaseModel):
    """GitHub Actions workflow context information."""
    ...
    actor: str  # GitHub user who triggered the workflow
